...
const LAYERS = [
  { number: '01', icon: Target,    label: 'Strategy Layer',   title: 'Strategy & Positioning',     benefit: 'Every project starts with a clear vision, roadmap, and market positioning — so every decision compounds toward your goals.',              outcomes: ['Brand positioning', 'Market research', 'Growth roadmap'],                        color: '#2563EB', bg: '#EFF6FF', href: '/services/strategy'   },
  { number: '02', icon: Eye,       label: 'Experience Layer', title: 'UI/UX & Product Design',      benefit: 'Intuitive, high-converting user journeys designed around your customers — not templates.',                                                outcomes: ['User research', 'Wireframing & prototyping', 'Conversion-first design'],          color: '#0EA5E9', bg: '#F0F9FF', href: '/services/ui-ux'      },
  { number: '03', icon: GitBranch, label: 'Technology Layer', title: 'Web, Mobile & Software',      benefit: 'Custom platforms built for speed, scale, and security — from landing pages to enterprise-grade applications.',                             outcomes: ['Custom web & mobile apps', 'Scalable architecture', 'API & integrations'],        color: '#1D4ED8', bg: '#EFF6FF', href: '/services/web-mobile' },
  { number: '04', icon: Award,     label: 'Brand Layer',      title: 'Branding & Identity',         benefit: 'A brand system that makes you unforgettable — logo, voice, visual identity, and guidelines built to last.',                               outcomes: ['Logo & identity system', 'Brand guidelines', 'Messaging & tone of voice'],        color: '#3B82F6', bg: '#EFF6FF', href: '/services/branding'   },
  { number: '05', icon: Video,     label: 'Media Layer',      title: 'Commercials & Video',         benefit: 'High-impact commercial videos, brand films, and ad creatives that capture attention and drive action across every screen.',                outcomes: ['Brand & product films', 'Ad creatives', 'Social content production'],             color: '#0369A1', bg: '#F0F9FF', href: '/services/video'      },
  { number: '06', icon: TrendingUp,label: 'Growth Layer',     title: 'Digital Marketing & Growth',  benefit: 'Data-driven campaigns across SEO, paid ads, email, and social — designed to compound in effectiveness every month.',                      outcomes: ['SEO & content marketing', 'Paid advertising', 'Analytics & optimisation'],        color: '#1E40AF', bg: '#EFF6FF', href: '/services/marketing'  },
];
