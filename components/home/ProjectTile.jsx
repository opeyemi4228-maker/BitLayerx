    ...
    >
      ...
      {variant === 0 && (
        <>
          ...
          {[0, 1, 2].map((i) => (
            <g key={i}>
              <rect x={26 + i * 118} y="134" width="102" height="62" rx="8" fill="#ffffff" />
      ...
      {variant === 1 && (
        <>
          ...
          {[0, 1].map((i) => (
            <rect key={i} x={120 + i * 138} y="56" width="122" height="56" rx="8" fill="#ffffff" />
          ))}
      ...
      {variant === 2 && (
        <>
          ...
          {[0, 1, 2].map((i) => (
            <g key={i}>
              <rect x="252" y={68 + i * 42} width="124" height="30" rx="6" fill="#ffffff" />
      ...
      {variant === 3 && (
        <>
          ...
          {[0, 1, 2, 3].map((i) => (
            <g key={i}>
              <rect x={22 + (i % 2) * 190} y={54 + Math.floor(i / 2) * 96} width="172" height="84" rx="10" fill="#ffffff" />
