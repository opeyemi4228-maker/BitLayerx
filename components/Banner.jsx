    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 mb-16 lg:mb-20">
          ...
          <FadeIn direction="left" delay={0.1} className="lg:max-w-xs">
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="text-gray-400 text-[13px] font-semibold">4.9 / 5.0</span>
            </div>
          ...
          >
            ...
            <div className="relative overflow-hidden bg-gray-50 border border-gray-100 min-h-[360px] flex flex-col justify-between">
              ...
              <AnimatePresence mode="wait" custom={direction}>
                ...
                >
                  ...
                  {/* Result badge */}
                  <div
                    className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-[11px] font-black tracking-wide uppercase mb-5 w-fit"
                  ...
                  {/* Quote text */}
                  <p className="text-gray-600 text-[14px] lg:text-[15px] leading-relaxed italic flex-1 mb-8">
                    "{t.quote}"
                  </p>
                  ...
                  <div className="flex items-center gap-3 pt-6 border-t border-gray-100">
                    <div
                      className="w-10 h-10 rounded-full flex items-center justify-center text-white font-black text-[13px] flex-shrink-0"
                      style={{ backgroundColor: t.color }}
                    >
                      {t.avatar}
                    </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex gap-3">
                <button
                  onClick={() => paginate(-1)}
                  className="flex-1 flex items-center justify-center gap-2 py-3.5 border border-gray-200 hover:border-[#000080]/30 hover:bg-gray-50 text-gray-400 hover:text-[#000080] font-bold text-[13px] rounded-xl transition-all duration-200"
              ...
              <Link
                ...
                className="flex items-center justify-center gap-1.5 text-[#0818A8] hover:text-[#000080] font-black text-[12px] uppercase tracking-wide transition-colors group"
              >
          ...
          {TESTIMONIALS.slice(0, 3).map((test, i) => (
            ...
            >
              <div className="flex items-center gap-2 mb-3">
                ...
                <div>
                  <p className="text-[#000080] font-black text-[12px]">{test.name}</p>
                  <p className="text-gray-400 text-[10px]">{test.company}</p>
                </div>
              </div>
        ...
        <FadeIn className="mt-16" delay={0.15}>
          <p className="text-center text-gray-300 text-[11px] font-black tracking-[0.2em] uppercase mb-8">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 lg:gap-10">
            {LOGOS.map((logo, i) => (
              ...
              >
                <span className="text-gray-400 font-black text-[12px] tracking-wide uppercase">
                  {logo}
                </span>
              </motion.div>
            ))}
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div>
            <FadeIn direction="right">
              <p className="text-blue-400 text-[11px] font-black tracking-[0.22em] uppercase mb-6 flex items-center gap-2">
              ...
              <ul className="space-y-3 mb-10">
                {CTA_BENEFITS.map((b, i) => (
                  <li key={i} className="flex items-center gap-3">
                    ...
                    <span className="text-white/60 text-[13px] font-medium">{b}</span>
                  </li>
                ))}
              </ul>
                ...
                <div className="flex items-start gap-5">
                  ...
                  <div className="flex-1">
                    ...
                    <Link
                      ...
                      className="inline-flex items-center gap-2 px-6 py-3 bg-[#000080] hover:bg-[#0818A8] text-white font-black text-[13px] rounded-xl transition-all duration-200 shadow-lg shadow-[#000080]/20 group/btn"
                    >
                      Start Your Project
              ...
              >
                <div className="flex items-start gap-5">
                  ...
                  <div className="flex-1">
                    ...
                    <Link
                      href="/contact/call"
                      className="inline-flex items-center gap-2 px-6 py-3 border border-white/15 hover:border-blue-400/40 text-white/70 hover:text-white font-bold text-[13px] rounded-xl transition-all duration-200 group/btn"
                    >
                      Book a Free Call
                ...
                <div className="flex items-start gap-5">
                  ...
                  <div className="flex-1">
                    ...
                    <Link
                      ...
                      className="inline-flex items-center gap-2 px-6 py-3 border border-white/10 hover:border-white/25 text-white/50 hover:text-white/80 font-bold text-[13px] rounded-xl transition-all duration-200 group/btn"
                    >
                      Request Proposal
                      <ArrowRight size={14} strokeWidth={2.5} className="group-hover/btn:translate-x-0.5 transition-transform" />
                    </Link>
                ...
                {[
                  ...
                  return (
                    <div key={i} className="flex items-center gap-1.5 text-white/25">
                      ...
                      <span className="text-[11px] font-semibold">{t.text}</span>
                    </div>
                  );
                })}
              </div>
