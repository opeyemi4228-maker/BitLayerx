...
export const PAGES = {
  ...
  "/packages": {
    title: "Packages & Prices, Websites From ₦800,000",
    description:
      "Websites from ₦800,000, marketing from ₦1.5m, custom software from ₦8m. Five packages with real starting prices and exactly what is in each one.",
    keywords: [
