...
export default function BitLayerxAboutPage() {
  const stats = [
    { value: '48hr', label: 'To a Written Plan', sublabel: 'From your first call' },
    { value: '6', label: 'Practices, One Team', sublabel: 'Strategy to growth' },
    { value: '2', label: 'Countries', sublabel: 'Nigeria & the UK' }
  ];
  ...
  const values = [
    ...
    },
    {
      ...
      description: 'From support automation to conversion-focused websites, we bring solutions built to keep working long after launch, proven to work for businesses like yours.'
    }
  ];
  ...
  const milestones = [
    ...
    },
    {
      ...
      description: 'Launched AI business automation services, taking repeatable manual work off client teams.'
    },
    {
      year: '2026',
      label: 'Market Leader',
    ...
    <div className="bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid md:grid-cols-3 gap-12">
            {stats.map((stat, index) => (
              ...
              >
                <div className="inline-block p-8 border-2 border-[#0040FF] mb-6 group-hover:bg-[#0040FF] transition-colors duration-300">
                  <div className="text-6xl lg:text-7xl font-bold text-[#0040FF] group-hover:text-white transition-colors">
                    {stat.value}
                  </div>
                </div>
      ...
      <section className="py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="mb-6">
                <span className="inline-block px-4 py-2 bg-[#0040FF] text-white text-sm font-semibold uppercase tracking-wide mb-6">
                  Our Mission
                </span>
              </div>
              <h2 className="text-4xl lg:text-5xl font-light text-gray-900 mb-8 leading-tight">
                To be <span className="font-bold text-[#0040FF]">Nigeria's most trusted</span> digital growth partner
              </h2>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-light text-gray-900 mb-6">
              Meet Our <span className="font-bold text-[#0040FF]">Leadership</span>
            </h2>
            ...
            {team.map((member, index) => (
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <p className="text-[#0040FF] font-semibold mb-4">{member.title}</p>
      ...
      <section className="py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-light text-gray-900 mb-6">
              What Makes Us <span className="font-bold text-[#0040FF]">Different</span>
            </h2>
          </motion.div>
