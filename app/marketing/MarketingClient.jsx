  ...
  const marketingServices = [
    {
      ...
      results: 'A content calendar you own, a consistent voice across every channel, and reporting you can read without us.',
    ...
    },
    {
      ...
      results: 'A technical baseline that stops working against you, content built around real search demand, and monthly reporting on what moved.',
    ...
    },
    {
      ...
      longDescription: 'Your email list is sitting on untapped revenue. Most businesses leave real revenue on the table by not nurturing their lists properly. Our email marketing service transforms your contacts into customers through strategic automation, compelling content, and data-driven optimization.',
      features: [
      ...
      results: 'Flows that run without you, a list you own outright, and honest reporting on what each sequence earns.',
    ...
    <div className="bg-white">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            {marketingServices.map((service) => (
              <a
                key={service.id}
                href={`#${service.id}`}
                className="px-6 py-3 bg-white text-black/80 font-semibold hover:bg-[#0040FF] hover:text-white transition-all duration-300 text-sm"
              >
                {service.title}
              </a>
            ))}
        ...
        >
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                {/* Icon */}
                <svg className="w-16 h-16 text-[#0040FF] mb-6" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                  {service.icon}
                </svg>
                ...
                <p className="text-xl text-[#0040FF] font-semibold mb-6">{service.subtitle}</p>
                ...
                {/* Pricing */}
                <div className="mb-8 p-6 bg-gradient-to-r from-[#0040FF]/10 to-[#0040FF]/10 border-l-4 border-[#0040FF]">
                  <div className="text-sm text-black/80 mb-2">Investment</div>
                  <div className="text-3xl font-bold text-[#0040FF] mb-2">{service.pricing.nigeria}</div>
                ...
                <div className="mb-8 p-6 bg-white border-2 border-gray-200">
                  ...
                  <div className="flex items-center gap-2 text-sm text-black/80">
                    <svg className="w-5 h-5 text-[#0040FF]" fill="currentColor" viewBox="0 0 20 20">
                ...
                <Link href="/contact">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="px-10 py-4 bg-gradient-to-r from-[#0040FF] to-[#0040FF] text-white text-lg font-semibold hover:shadow-xl transition-all duration-300"
                  >
                ...
                <ul className="space-y-3">
                  {service.features.map((feature, idx) => (
                    <li key={idx} className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-[#0040FF] flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/>
                      </svg>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-12">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-light text-gray-900 mb-4">
              Frequently Asked <span className="font-bold text-[#0040FF]">Questions</span>
            </h2>
          </motion.div>
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <motion.div
                ...
                className="bg-white border-l-4 border-[#0040FF] p-6"
              >
                <button
                ...
                >
                  ...
                  <svg
                    className={`w-6 h-6 text-[#0040FF] flex-shrink-0 transition-transform ${
      ...
      <section className="relative py-20 lg:py-28 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-12 text-center text-white">
          ...
          >
            Ready to <span className="font-bold">Compound</span> Your Growth?
          </motion.h2>
