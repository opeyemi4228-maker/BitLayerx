            ...
            {challenges.map((challenge, index) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-700 font-medium">{challenge.solution}</p>
                </div>
              </motion.div>
            ))}
          </div>
          ...
          >
            <div className="bg-gradient-to-br from-gray-50 to-white border-2 border-[#0818A8] p-10 lg:p-12 shadow-2xl">
              <div className="text-center mb-8">
                ...
                <p className="text-lg text-gray-700 mb-6">{selectedPackage.description}</p>
                <div className="flex items-baseline justify-center gap-2 mb-2">
                  <span className="text-5xl font-bold text-[#0818A8]">{selectedPackage.price}</span>
                </div>
                <div className="text-sm text-gray-600 mb-4">{selectedPackage.priceUK} (UK pricing)</div>
            ...
            {successStories.map((story, index) => (
              ...
              >
                ...
                <div className="pt-4 border-t border-gray-200">
                  ...
                  <p className="text-sm text-gray-700">{story.results}</p>
                </div>
              </motion.div>
            ))}
          </div>
