    ...
    <div className="bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              We Get It. <span className="text-[#0040FF]">Startups Are Hard.</span>
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {challenges.map((challenge, index) => (
              <motion.div
                ...
                className="bg-white p-8 border-l-4 border-[#0040FF] hover:shadow-xl transition-all duration-300"
              >
                <svg className="w-12 h-12 text-[#0040FF] mb-4" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                  {challenge.icon}
                </svg>
      ...
      <section id="packages" className="py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              Choose Your <span className="text-[#0040FF]">Startup Stage</span>
            </h2>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white border-2 border-[#0040FF] p-10 lg:p-12 shadow-2xl">
              <div className="text-center mb-8">
                ...
                <div className="flex items-baseline justify-center gap-2 mb-2">
                  <span className="text-5xl font-bold text-[#0040FF]">{selectedPackage.price}</span>
                </div>
                <div className="text-sm text-black/80 mb-4">{selectedPackage.priceUK} (UK pricing)</div>
                <div className="inline-block px-4 py-2 bg-[#0040FF] text-white font-semibold">
                  ...
                  <ul className="space-y-3">
                    {selectedPackage.features.map((feature, idx) => (
                      <li key={idx} className="flex items-start gap-3">
                        <svg className="w-6 h-6 text-[#0040FF] flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4">
                <Link href="/contact" className="flex-1">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full py-4 bg-gradient-to-r from-[#0040FF] to-[#0040FF] text-white text-lg font-bold"
                  >
                    Get Started
                  </motion.button>
                </Link>
                <a href="https://wa.me/2348034567890" className="flex-1">
                  <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="w-full py-4 bg-transparent text-[#0040FF] text-lg font-bold border-2 border-[#0040FF]"
                  >
                    Chat on WhatsApp
                  </motion.button>
                </a>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-12 text-center">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              ...
              <span className="text-[#0040FF]">we will show you.</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/contact"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 border border-gray-300 text-gray-700 hover:text-[#0040FF] hover:border-[#0040FF]/40 font-bold rounded-xl transition-all"
              >
                Talk to the founder
              </Link>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-12">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
              Founder <span className="text-[#0040FF]">FAQs</span>
            </h2>
          </motion.div>
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <motion.details
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1 }}
                className="bg-white p-6 border-l-4 border-[#0040FF] group"
              >
                <summary className="flex items-center justify-between cursor-pointer list-none font-bold text-lg text-gray-900">
                  <span>{faq.question}</span>
                  <svg className="w-6 h-6 group-open:rotate-180 transition-transform text-[#0040FF]" fill="currentColor" viewBox="0 0 20 20">
