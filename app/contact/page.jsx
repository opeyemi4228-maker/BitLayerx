...
function Field({ label, required, children, hint }) {
  return (
    <div>
      <label className="block text-[14px] font-black uppercase tracking-[0.18em] text-gray-500 mb-2">
        {label}{required && <span className="text-[#0818A8] ml-0.5">*</span>}
      </label>
      {children}
      {hint && <p className="text-[14px] text-gray-400 mt-1 font-medium">{hint}</p>}
    </div>
  );
}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 pt-36 sm:pt-44 pb-20">
        <div className="max-w-3xl">
          ...
          <motion.p initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }}
            ...
            Ready to transform your digital presence? Get in touch — a BitLayerX strategist will respond within 24 hours with a clear, tailored plan.
          </motion.p>
          ...
          <motion.div ref={sideRef}
            ...
            <div className="relative rounded-2xl overflow-hidden"
              ...
              <div className="relative z-10 p-7">
                <p className="text-blue-300 text-[14px] font-black tracking-[0.26em] uppercase mb-4 flex items-center gap-2">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    "A strategist schedules a discovery call",
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-6"
              style={{ boxShadow: "0 2px 12px rgba(0,0,80,0.04)" }}>
              <p className="text-[14px] font-black tracking-[0.24em] uppercase text-gray-300 mb-4">Why Work With Us</p>
              <div className="space-y-3">
            ...
            <div className="bg-[#f8f9fc] border border-gray-100 rounded-2xl p-6">
              <p className="text-[14px] font-black tracking-[0.24em] uppercase text-gray-300 mb-4">Quick Answers</p>
              ...
              <div className="relative h-52 overflow-hidden">
                ...
                <div className="absolute bottom-4 left-5 flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-white/70 text-[14px] font-medium">{o.country}</p>
                  </div>
                </div>
              </div>
    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          url: "https://bitlayerx.org/contact",
          mainEntity: {
            "@type": "Organization",
            name: "BitLayerX",
            ...
            contactPoint: [
              ...
              { "@type": "ContactPoint", email: "hello@bitlayerx.org", contactType: "sales" },
            ],
          },
        }),
      }} />
